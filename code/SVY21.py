'''
This is not code that we wrote for the project. This is open source code available at https://gist.github.com/jovianlin/30b0fd93e2b835cb1e8d93bfa0e1e62f, thanks to Jovian Lin.

Since Singapore has a special coordinate system called SVY21, and some of the government data stores location data in SVY21 format, we need to convert from SVY21 to more commonly used coordinate reference system WGS84, which is a latitude-longitude projection used in software such as Google Maps.
'''
