...
\textbf{Preferences} & Quality and quantity scores for primary and secondary schools, clinics, hawker centers. Quantity scores for subway (MRT) stations. & 7 out of the 9 quantity and quality scores for the preferred features were in the top quartile (Q4). The remaining two were within the third quartile (Q3). \\\hline
    \end{tabular}
...
\textbf{Preferences} & 
Quantity and quality scores for sports facilities, gyms, community centers, hawker centres. Quantity scores for F\&B, subway (MRT) stations, taxi stands. & 
